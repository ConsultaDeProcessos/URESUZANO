...
// Versão 11.9.3 — Mensagens Originais + API Fix
// ============================================================ 
...
async function consultarProcesso() {
    ...
    try {
        // Ajuste para suportar tanto GET quanto POST da nova API
        ...
        // Lógica para ler a nova estrutura da API (data.resultados)
...
// --- MOTOR DE HUMANIZAÇÃO (ORIGINAL RESTAURADO) ---
